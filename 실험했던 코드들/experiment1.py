    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            for inputs, labels in test_loader:
                ...
                outputs = model(inputs)
                preds = (torch.sigmoid(outputs) >= 0.5).float()
                test_correct += (preds.view(-1) == labels).sum().item()
        ...
        if test_accuracy == 1.0:
            print("테스트 데이터에서 정확도 100% 달성. 학습을 중단합니다.")
            break
...
# Epoch 1/50, Loss: 0.2537, LR: 9.757729755661011e-05
# Validation Loss: 0.1065, Accuracy: 1.0000
# 모델 저장됨
# Test Accuracy: 0.8750
# Epoch 2/50, Loss: 0.1506, LR: 9.05463412215599e-05
# Validation Loss: 0.1261, Accuracy: 0.9375
# Test Accuracy: 0.8526
# Epoch 3/50, Loss: 0.1200, LR: 7.959536998847742e-05
# Validation Loss: 0.1798, Accuracy: 0.8750
# Test Accuracy: 0.9071
# Epoch 4/50, Loss: 0.1007, LR: 6.57963412215599e-05
# Validation Loss: 0.0800, Accuracy: 1.0000
# 모델 저장됨
# Test Accuracy: 0.9167
# Epoch 5/50, Loss: 0.0778, LR: 5.05e-05
# Validation Loss: 0.1470, Accuracy: 0.9375
# Test Accuracy: 0.8974
# Epoch 6/50, Loss: 0.0733, LR: 3.5203658778440106e-05
# Validation Loss: 0.0892, Accuracy: 0.9375
# Test Accuracy: 0.9407
# Epoch 7/50, Loss: 0.0665, LR: 2.1404630011522586e-05
# Validation Loss: 0.1478, Accuracy: 0.8750
# Test Accuracy: 0.9279
# Epoch 8/50, Loss: 0.0691, LR: 1.0453658778440107e-05
# Validation Loss: 0.3094, Accuracy: 0.6875
# Test Accuracy: 0.9022
# Epoch 9/50, Loss: 0.0618, LR: 3.4227024433899e-06
# Validation Loss: 0.1529, Accuracy: 0.8750
# 조기 종료 발동
# c:\Users\AERO\Downloads\Chest-X-Ray-Kaggle-main\Chest-X-Ray-Kaggle-main\aa.py:175: FutureWarning: You are using `torch.load` with `weights_only=False` (the current default value), which uses the default pickle module implicitly. It is possible to construct malicious pickle data which will execute arbitrary code during unpickling (See https://github.com/pytorch/pytorch/blob/main/SECURITY.md#untrusted-models for more details). In a future release, the default value for `weights_only` will be flipped to `True`. This limits the functions that could be executed during unpickling. Arbitrary objects will no longer be allowed to be loaded via this mode unless they are explicitly allowlisted by the user via `torch.serialization.add_safe_globals`. We recommend you start setting `weights_only=True` for any use case where you don't have full control of the loaded file. Please open an issue on GitHub for any issues related to this experimental feature.       
#   model.load_state_dict(torch.load("pneumonia_detection_model_optimized.pth"))
# Test Accuracy: 0.9167
